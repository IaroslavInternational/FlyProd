...
* 
* Добавить пины [34, 36, 38, 40, 42, 44], как GND: ADD_GND (1 - включить пины, как GND; 0 - не включать)
* Добавить пины [25, 26], как +5V: ADD_5V (1 - включить пины, как GND; 0 - не включать)
* 
...
#define K_REV 1.0   // Коэф. отношения насоса 2 к насосу 1
...
void setup()
{
    ...
    {
        int gnd_pins[] = { 34, 36, 38, 40, 42, 44 }; // Пины для GND
